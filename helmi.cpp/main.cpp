...
int main(){
    cout << endl;
    cout << "\t\t\t\t Program urutan 5 Bilangan dari" << endl;
    cout << "\t\t\t\t yang terkecil hingga yang terbesar" << endl<<endl;
    mainhub:
    cout << "    Masukkan angka 1 = "; cin >> a;
    cout << "    Masukkan angka 2 = "; cin >> b;
    cout << "    Masukkan angka 3 = "; cin >> c;
    cout << "    Masukkan angka 4 = "; cin >> d;
    cout << "    Masukkan angka 5 = "; cin >> e;
if ((a == b)||(a==c)||(a==d)||(a==e)||(b==c)||(b==d)||(b==e)||(c==d)||(c==e)||(d==e))
{
    ...
    cout << "        KARENA ADA ANGKA YANG SAMA!" << endl;
}
else{
